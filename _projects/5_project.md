...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/keyfob.png" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/keyfob.png" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
...
<div class="caption">
    Early CAD drawing of my custom, 3D-printed Mazda CX-5 keyfob. Updates coming soon.
</div>
<!-- <div class="row">
    <div class="col-sm mt-3 mt-md-0">
